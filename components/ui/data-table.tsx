...
export function DataTable<TData, TValue>({
  ...
  // Check Route with personal hook with UseRouteCheck
  const dashboardRoute = useRouteCheck([''])
  const customersRoute = useRouteCheck(['customer'])
  const ordersRoute = useRouteCheck(['orders'])
  const productsRoute = useRouteCheck(['products'])

  const columnName= customersRoute ? "name" : ordersRoute ? "orderNumber" : productsRoute ? "name" : ""
